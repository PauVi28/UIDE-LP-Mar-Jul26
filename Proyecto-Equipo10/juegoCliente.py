        ...
        if evento.type == pygame.MOUSEBUTTONDOWN:
            ...
            #SELECCIÓN EQUIPOS
                ...
                if modo_local:
                    ...
                    if boton_confirmar_seleccion2.collidepoint(evento.pos):
                        if not confirmacion_j2:
                            pais_j2 = paises[indice_j2]
                            confirmacion_j2 = True
                            if conectado:
...
#MENÚ
    if escena == "menu_principal":
        ...
        texto = fuente_2.render("MODO CLIENTE", True, (255, 255, 255))
...
#BUSCANDO CONEXIÓN
        ...
        if not conectado:
            texto = fuente_5.render("BUSCANDO SERVIDOR...", True, (255, 255, 255))
            pantalla.blit(texto, (175, 230))
        else:
            texto = fuente_4.render("CONTECTADO CON EL JUGADOR 1", True, (255, 255, 255))
            pantalla.blit(texto, (106, 230))
...
#J2_PATEA
        ...
        if modo_local:
            ...
            if decision_j2 is not None and not confirmacion_online_j1:
                texto = fuente_3.render(f"ESPERANDO LA DECISIÓN DE {pais_j1}", True, (0, 0, 0))
